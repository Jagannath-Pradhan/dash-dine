...
// export default function ClientAddress({ user }) {
...
//     // Mock addresses — replace with API later
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="flex items-center justify-center mb-6 sm:mb-8 overflow-x-auto">
          <div className="flex items-center min-w-max">
            <div className="flex items-center">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-green-500 text-white rounded-full flex items-center justify-center font-bold text-sm sm:text-base">
                ✓
              </div>
              <span className="ml-2 font-semibold text-green-600 text-xs sm:text-base">
                Cart
              </span>
            </div>
            <div className="w-12 sm:w-20 h-1 bg-orange-500 mx-2" />
            <div className="flex items-center">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-orange-500 text-white rounded-full flex items-center justify-center font-bold text-sm sm:text-base">
                2
              </div>
              <span className="ml-2 font-semibold text-orange-600 text-xs sm:text-base">
                Address
              </span>
            </div>
            <div className="w-12 sm:w-20 h-1 bg-gray-300 mx-2" />
            <div className="flex items-center">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gray-300 text-gray-600 rounded-full flex items-center justify-center font-bold text-sm sm:text-base">
                3
              </div>
              <span className="ml-2 text-gray-500 text-xs sm:text-base">
                Payment
              </span>
            </div>
          </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <button
              ...
              className="w-full border-2 border-dashed border-orange-300 hover:border-orange-500 rounded-xl p-4 sm:p-6 flex items-center justify-center gap-3 transition-colors group"
            >
              <Plus className="w-5 h-5 sm:w-6 sm:h-6 text-orange-500" />
              <span className="font-semibold text-sm sm:text-base text-gray-700 group-hover:text-orange-600">
                Add New Address
              </span>
            </button>
          ...
          {/* Order Summary */}
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-lg p-4 sm:p-5 lg:sticky lg:top-6">
              <h3 className="font-bold text-lg mb-4">Order Summary</h3>
