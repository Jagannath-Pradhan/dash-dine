        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-8">
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              {isLoggedIn && (
                <a href="#orders" className={`transition ${
                  isScrolled ? 'text-gray-700 hover:text-orange-500' : 'text-white hover:text-orange-300'
                }`}>My Orders</a>
              )}
            </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            {isLoggedIn ? (
              ...
              <button
                onClick={onLogin}
                className={`flex items-center space-x-2 px-6 py-2 rounded-lg hover:shadow-lg transition ${
                  isScrolled
                ...
                <>
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-center space-x-2 px-4 py-2 rounded-lg ${
                      isScrolled ? 'bg-gray-100' : 'bg-white bg-opacity-20 text-white'
                    }`}
                  >
                    <LogOut className="w-4 h-4" />
                    <span>Logout</span>
